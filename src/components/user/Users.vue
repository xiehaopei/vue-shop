      ...
      <el-row :gutter="20">
        ...
        <el-col :span="4">
          <el-button type="primary"
                     @click="dialogShow">添加用户</el-button>
        </el-col>
      </el-row>
        ...
        <el-table-column prop="mg_state"
          ...
          <template v-slot:default="slotProps">
            <el-switch v-model="slotProps.row.mg_state"
                       @change="userStateChanged(slotProps.row)"></el-switch>
          </template>
        </el-table-column>
          ...
          <template v-slot:default="slotProps">
            ...
            <el-tooltip effect="dark"
              ...
              <el-button type="primary"
                         icon="el-icon-edit"
                         size="mini"
                         @click="showEditDialog(slotProps.row.id)"></el-button>
            </el-tooltip>
            <!-- 删除按钮 -->
            <el-tooltip effect="dark"
                        content="删除"
              ...
              <el-button type="danger"
                         icon="el-icon-delete"
                         size="mini"
                         @click="removeUserById(slotProps.row.id)"></el-button>
            </el-tooltip>
            <!-- 分配角色按钮 -->
            <el-tooltip effect="dark"
                        content="分配角色"
